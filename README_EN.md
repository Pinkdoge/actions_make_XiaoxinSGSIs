...
**Note: The automated production tools is only compatible with v1.9 of SGSI-build-tool and only supports the production of above-mentioned customized systems for Android 10-AB partitions.**

## Start

After Fork this repositories, click 'Star' on the upper right corner to start.

## Compilation result
When the process of compilation is finished, the output(7z Compressed file) will be uploaded, you can see the form for more details.
